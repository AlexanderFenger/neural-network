...
class Simulation:
    ...
    def __event_at_basket(self, basket, position):
        ...
        event = Event(real_primary_energy=basket['MCEnergy_Primary'][position],
                      ...
                      real_e_interactions=basket['MCInteractions_e'][position],
                      real_p_positions=basket['MCPosition_p'][position],
                      real_p_interactions=basket['MCInteractions_p'][position],
                      real_src_pos=basket['MCPosition_source'][position],
                      real_src_dir=basket['MCDirection_source'][position],
                      ...
                      event_type=basket['MCSimulatedEventType'][position],
